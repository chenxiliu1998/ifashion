...
class TripleRoIHeads(RoIHeads):
    ...
    def forward(self, features, proposals, image_shapes, targets=None):
        ...
        if self.training:
            ...
            # print(attrs)
            # set_trace()
            # TODO: add attribute classify loss
            losses = {
...
class TripleFasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        # TODO: use TripleRoIHeads modify @zhengkai
        # roi_heads = RoIHeads(
...
# TODO: attribute分支
# attribute class (295) for a RoI
"""
- maskrcnn loss
https://github.com/pytorch/vision/blob/master/torchvision/models/detection/roi_heads.py#L801
...
def get_model_instance_segmentation(num_classes):
    ...
    # replace the pre-trained head with a new one (due to the different num_classes)
    ...
    # model.roi_heads.attr_predictor = AttrPredictor(
