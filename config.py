...
train_arg.add_argument("--img_dir", type=str,
                       default="/media/lin/FreeAgent G/imaterialist-fashion-2020-fgvc7/train/",
                       help="Directory with train dataset")

train_arg.add_argument("--ann_path", type=str,
                       default="/media/lin/FreeAgent G/imaterialist-fashion-2020-fgvc7/train.csv",
                       help="Directory with train dataset")

train_arg.add_argument("--test_dir", type=str,
                       default="/media/lin/FreeAgent G/imaterialist-fashion-2020-fgvc7/test/",
                       help="Directory with test dataset")

train_arg.add_argument('--sample_path', type=str,
                       default= '/media/lin/FreeAgent G/imaterialist-fashion-2020-fgvc7/sample_submission.csv',
                       help = 'Directory with test dataset')
...
train_arg.add_argument("--save_dir", type=str,
                       default="/media/lin/FreeAgent G/imaterialist-fashion-2020-fgvc7/save",
